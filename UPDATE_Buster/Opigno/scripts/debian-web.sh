...
mkdir /var/www/mylms
wget -qO - https://ftp.drupal.org/files/projects/opigno_lms-7.x-1.41-core.tar.gz | tar zxv -C /var/www/mylms/ --strip-components 1
...
wget -qO - https://github.com/RusticiSoftware/TinCanPHP/archive/1.1.1.tar.gz | tar zxv -C /var/www/mylms/sites/all/libraries/TinCanPHP/  --strip-components 1
