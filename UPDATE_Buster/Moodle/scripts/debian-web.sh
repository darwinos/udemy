...
wget -O /etc/apache2/sites-available/mylms.conf https://raw.githubusercontent.com/darwinos/udemy/master/UPDATE_Buster/Moodle/files/mylms.conf

# Download and extract Moodle

mkdir /var/www/mylms
wget -qO - https://download.moodle.org/download.php/direct/stable37/moodle-latest-37.tgz | tar zxv -C /var/www/mylms/ --strip-components 1
