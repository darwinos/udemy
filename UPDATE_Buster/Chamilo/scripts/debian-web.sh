...
wget -O /etc/apache2/sites-available/mylms.conf https://raw.githubusercontent.com/darwinos/udemy/master/UPDATE_Buster/Chamilo/files/mylms.conf

# Download and extract Chamilo

mkdir /var/www/mylms
wget -qO - https://github.com/chamilo/chamilo-lms/releases/download/v1.11.10/chamilo-1.11.10-php7.tar.gz | tar zxv -C /var/www/mylms/ --strip-components 1
